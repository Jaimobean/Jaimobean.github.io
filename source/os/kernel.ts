...
module TSOS {
    ...
    export class Kernel {
        ...
        public krnBootstrap() {      // Page 8. {
            ...
            _PriorityQueue = new Queue();         // To help sort programs by Priority
        ...
        public loadHexFromFileToMem(filename){
        ...
        public setCPUValuesFromPCB(current) {
            ...
            if (_CurrentProcess.Location !== "In Memory") {
                ...
                Control.hostLog("PID " + temp.PID + "Swapped to Disk", "Kernel");
                ...
                Control.hostLog("PID " + _CurrentProcess.PID + "Swapped to Memory", "Kernel");
