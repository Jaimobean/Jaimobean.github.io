...
(function (TSOS) {
    var Shell = (function () {
        ...
        Shell.prototype.init = function () {
            ...
            this.commandList[this.commandList.length] = sc;
            // load
            sc = new TSOS.ShellCommand(this.shellLoad, "load", "<priority> - Loads programs user inputted with priority if given");
            this.commandList[this.commandList.length] = sc;
            // run
            ...
            sc = new TSOS.ShellCommand(this.shellFormat, "format", "- Initializes all tracks, sectors and blocks on the disk");
            this.commandList[this.commandList.length] = sc;
            // setschedule - allows user to set cpu scheduling algorithm
            sc = new TSOS.ShellCommand(this.shellSetScheduler, "setschedule", "<schedule> - User may choose cpu scheduling algorithms rr, fcfs, or priority");
            this.commandList[this.commandList.length] = sc;
            // getschedule - tells user the current cpu scheduling algorithm
            sc = new TSOS.ShellCommand(this.shellGetScheduler, "getschedule", "- Tells user the current cpu scheduling algorithm");
            this.commandList[this.commandList.length] = sc;
            // create - allows user to create file with specified name
            sc = new TSOS.ShellCommand(this.shellCreateFile, "create", "<filename> - File names must be less than 60 characters and contain no spaces.");
            this.commandList[this.commandList.length] = sc;
            // delete - allows user to delete file with specified name
            sc = new TSOS.ShellCommand(this.shellDeleteFile, "delete", "<filename> - File name of file to be deleted.");
            this.commandList[this.commandList.length] = sc;
            // delete - allows user to delete file with specified name
            sc = new TSOS.ShellCommand(this.shellWriteFile, "write", "<filename>, 'text' - Contents to be written to the file.");
            this.commandList[this.commandList.length] = sc;
            // read - allows user to read file with specified name
            sc = new TSOS.ShellCommand(this.shellReadFile, "read", "<filename> - File name of file to read.");
            this.commandList[this.commandList.length] = sc;
            // ls - lists all file names in directory
            sc = new TSOS.ShellCommand(this.shellListFiles, "ls", "- Lists all filenames in File System.");
            this.commandList[this.commandList.length] = sc;
            //
